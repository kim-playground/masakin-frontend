...
const SidebarTrigger = forwardRef, React.ComponentProps<typeof Button>>(
...
const SidebarInput = forwardRef, React.ComponentProps<typeof Input>>(
  ({ className, ...props }, ref) => {
    return (
      <Input
        ref={ref}
...
const SidebarSeparator = forwardRef, React.ComponentProps<typeof Separator>>(
  ({ className, ...props }, ref) => {
    return (
      <Separator
        ref={ref}
...
const SidebarGroupLabel = forwardRef & { asChild?: boolean }>(
...
const SidebarGroupAction = forwardRef & { asChild?: boolean }>(
  ({ className, asChild = false, ...props }, ref) => {
